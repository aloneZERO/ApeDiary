...
<!--[if (!IE)|(gte IE 8.0)]><!-->
<link href="${pageContext.request.contextPath}/template/notfound/qbase_datauri.css" type=text/css rel=stylesheet/>
<!--<![endif]-->
<STYLE type=text/css>
.mod-notfound {
	...
	<DIV class="mod-page-main wordwrap clearfix">
		<DIV class=x-page-container>
			<DIV class="mod-notfound grid-98">
				<IMG class=img-notfound height=320 src="${pageContext.request.contextPath}/template/notfound/notfound.gif" width=520>
				<P style="FONT-SIZE: 24px; LINE-HEIGHT: 70px">啊~哦~
					您要查看的页面不存在或已删除！</P>
				<P style="MARGIN-BOTTOM: 30px">请检查您输入的网址是否正确，或者点击链接继续浏览空间</P>
				<P style="FONT-SIZE: 14px; LINE-HEIGHT: 20px">
					您可以回到 <A href="${pageContext.request.contextPath}">网站首页</A>
			</DIV>
		</DIV>
	</DIV>
	</SECTION>
